    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
                ...
                html += "<tr><th>Booking Datetime</th>";
                html += "<th>Expected Return Datetime</th>";
                ...
                if (data.result) {
                    data.result.forEach(function (item) {
                        let d = new Date(item.booking_datetime);
                        d = GetYourDateFormatted(d);
                        let d1 = new Date(item.return_datetime);
                        d1 = GetYourDateFormatted(d1);
                        html += "<tr>";
                        html += "<td>" + d + "</td>";
                        html += "<td>" + d1 + "</td>";
                        ...
                        if (item.is_returned === "1" || item.is_returned === 1) {
                            html += "<td id='td-" + item.booking_id + "-" + item.is_returned + "-" + item.vehicle_id + "-" + item.length_of_booking + "' align='center'><a onclick='notifyBookingComplete(" + item.booking_id + ",this);'><i class='fas fa-bell' style='color: blue; font-size: 20px;cursor: pointer;'></i></a>";
                        } else {
                            html += "<td id='td-" + item.booking_id + "-" + item.is_returned + "-" + item.vehicle_id + "-" + item.length_of_booking + "' align='center'><a onclick='notifyBookingComplete(" + item.booking_id + ",this);'><i class='fas fa-bell' style='color: green; font-size: 20px;cursor: pointer;'></i></a>";
                        }
...
function GetYourDateFormatted(date) {
